...
run_name <- mod_id
predictor_dir <- "../predictors/predictors_invertebrates"
obs_dir <- "../observations/invertebrates"
spec_list_file <- "spec_list_invertebrates.csv"
...
method_pred <- FALSE # Add method as a predictor variable/covariate?
